...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('👩‍💻 ʀᴇᴘᴏ ✨', url='https://github.com/nikhiaskmovie/autofiltern'),
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('👩‍💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 👩‍💻', url='https://github.com/nikhiaskmovie/autofiltern'), #Please Change your bot username
